...
//
//  Created by Miller, Wyatt on 4/27/18.
...
{
    if(internalStorate[findPosition(value)]->getData() == value->getData())
    {
        return true;
    }
...
template <class Type>
Hashtable<Type> :: handleCollision(HashNode<Type> * current, long index)
{
    long shift;
...
void Hashtable<Type> :: resize()
{
    ...
    std :: fill_n(tempStorage, capacity, nullptr);
    
    long oldCapacity = this->capacity;
    this->capacity = updatedCapacity;
    
    for(long insex = 0; index < oldCapacity; index++)
    {
