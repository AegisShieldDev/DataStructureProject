...
//
//  Created by Miller, Wyatt on 4/23/18.
...
template <class Type>
N_AryTreeNode<Type> :: N_AryTreeNode<Type>()
{
}
template <class Type>
N_AryTreeNode<Type> :: N_AryTreeNode<Type>(Type data) : Node<Type>(data)
{
}
...
template <class Type>
void N_AryTreeNode<Type> :: getChildCount()
{
    return nodes.size();
}
