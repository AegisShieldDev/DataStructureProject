...
//
//  Created by Miller, Wyatt on 3/23/18.
...
void GraphTester :: compareTraversals()
{
    ...
    cout << "Min: " << min << " at " << minIndex << " Max: " << max << " at  " << maxIndex << endl;
    cout << "BreadthFirstTraversal at min " << min << endl;
    puzzle.breadthFirstTraversal(puzzle, minIndex);
    cout << "BreadthFirstTraversal at max " << max << endl;
